...
hi Normal       guifg=#3A3A3A guibg=#FFFFFF

" {{{ Cursor
hi Cursor		guibg=#444454 guifg=#FFFFFF
...
hi MatchParen	guibg=#cdcdfd guifg=#3A3A3A
hi Underlined	guifg=#3A3A3A gui=underline
...
hi IncSearch	guibg=#cdcdfd guifg=#3A3A3A gui=italic
hi Search		guibg=#cdcdfd guifg=#3A3A3A gui=italic
" }}}
...
hi Statement	guifg=#2239A8 gui=bold
...
hi Label        guifg=#2239A8 gui=bold
hi StorageClass guifg=#2239A8 gui=bold
hi Structure    guifg=#2239A8 gui=bold
hi TypeDef      guifg=#2239A8 gui=bold
" }}}
...
hi PmenuSel     guibg=#cdcdfd guifg=#3A3A3A gui=italic
hi PmenuSbar    guibg=#3A3A3A guifg=#444444
