...
hi Normal       guifg=#474747 ctermfg=16   guibg=#FFFFFF ctermbg=231  gui=NONE cterm=NONE
...
hi LineNr       guifg=#AAAAAA ctermfg=250  guibg=#ECECEC ctermbg=255  gui=NONE cterm=NONE
hi NonText      guifg=#808080 ctermfg=244  guibg=#FFFFFF ctermbg=255  gui=NONE cterm=NONE
...
hi MatchParen   guifg=#3A3A3A ctermfg=16   guibg=#CDCDFD ctermbg=189  gui=NONE cterm=NONE
hi Underlined   guifg=#3A3A3A ctermfg=16   gui=UNDERLINE cterm=UNDERLINE
...
hi IncSearch    guifg=#3A3A3A ctermfg=16   guibg=#CDCDFD ctermbg=189  gui=ITALIC cterm=ITALIC
hi Search       guifg=#3A3A3A ctermfg=16   guibg=#CDCDFD ctermbg=189  gui=ITALIC cterm=ITALIC
hi Ignore       guifg=#808080 ctermfg=244  gui=NONE cterm=NONE
" block variable
hi Identifier   guifg=#0086B3 ctermfg=31   gui=NONE cterm=NONE
hi PreProc      guifg=#000000 ctermfg=247  gui=BOLD cterm=BOLD
...
" if end do
hi Statement    guifg=#0086B3 ctermfg=16   gui=NONE cterm=BOLD
hi Type         guifg=#008080 ctermfg=60   gui=NONE cterm=BOLD
...
hi Error        guifg=#FFFFFF ctermfg=231  guibg=#EF5939 ctermbg=203  gui=NONE cterm=NONE
hi ErrorMsg     guifg=#FFFFFF ctermfg=231  guibg=#EF5939 ctermbg=203  gui=NONE cterm=NONE
hi Todo         guifg=#FFFFFF ctermfg=231  guibg=#EF5939 ctermbg=203  gui=UNDERLINE cterm=UNDERLINE
hi Label        guifg=#2239A8 ctermfg=16   gui=BOLD cterm=BOLD
hi StorageClass guifg=#2239A8 ctermfg=16   gui=BOLD cterm=BOLD
hi Structure    guifg=#2239A8 ctermfg=16   gui=BOLD cterm=BOLD
hi TypeDef      guifg=#2239A8 ctermfg=16   gui=BOLD cterm=BOLD
...
hi PmenuSel     guifg=#3A3A3A ctermfg=16   guibg=#CDCDFD ctermbg=189  gui=ITALIC cterm=ITALIC
hi PmenuSbar    guifg=#444444 ctermfg=238  guibg=#3A3A3A ctermbg=16   gui=NONE cterm=NONE
...
hi Cursor       guifg=#FFFFFF ctermfg=231  guibg=#444454 ctermbg=238  gui=NONE cterm=NONE
